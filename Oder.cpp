...
char Order::WaveRefreshTime[12] = { 
	0x12, 0x34, 0x00, 0x0F, 0xFA, 0x11, 0x00, 0x00, 0x03, 0xE8, 0xAB, 0xCD };

char Order::TriggerThreshold[12] = {
	0x12, 0x34, 0x00, 0x0F, 0xFA, 0x12, 0x00, 0x00, 0x00, 0x64, 0xAB, 0xCD };

char Order::TriggerIntervalTime[12] = {
	0x12, 0x34, 0x00, 0x0F, 0xFA, 0x14, 0x00, 0x00, 0x00, 0x32, 0xAB, 0xCD };

char Order::WorkMode[12] = {
	0x12, 0x34, 0x00, 0x0F, 0xFA, 0x13, 0x00, 0x00, 0x00, 0x05, 0xAB, 0xCD };

char Order::HardTouchStart[12] = {
	0x12, 0x34, 0x00, 0x0F, 0xFF, 0xA0, 0x00, 0x00, 0x00, 0x02, 0xAB, 0xCD };

char Order::SoftTouchStart[12] = {
