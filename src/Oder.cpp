...
BYTE Order::relay_ON[10] = {
	0x48, 0x3A, 0x01, 0x70, 0x01, 0x01, 0x00, 0x00, 0x45, 0x44 };

BYTE Order::relay_OFF[10] = {
	0x48, 0x3A, 0x01, 0x70, 0x01, 0x00, 0x00, 0x00, 0x45, 0x44 };

BYTE Order::relay_GetStatus[10] = {
	0x48, 0x3A, 0x01, 0x72, 0x01, 0x00, 0x00, 0x00, 0x45, 0x44 };

BYTE Order::relay_StatusON[10] = {
	0x48, 0x3A, 0x01, 0x71, 0x01, 0x01, 0x00, 0x00, 0x45, 0x44 };

BYTE Order::relay_StatusOFF[10] = {
	0x48, 0x3A, 0x01, 0x71, 0x01, 0x00, 0x00, 0x00, 0x45, 0x44 };